...
<script>
  ...
  import store, { CHANGE_TURN, CLICK_CELL, NO_WINNER, RESET_GAME, SET_WINNER } from './store';  // 최상위 컴포넌트와 store 연결
  ...
  export default {
    ...
    computed: {
      ...mapState(['winner', 'turn', 'tableData']), // store에서 mapSate로 한방에 state 가져오기
      // winner() {
